...
{
	game->text.wall = mlx_load_png("./textures/wallsA.png");
	if (!game->text.wall)
		ft_errors(game, "WALL TEXTURE IS A MESS", 1);
	game->text.floor = mlx_load_png("./textures/floor.png");
	if (!game->text.floor)
		ft_errors(game, "FLOOR TEXTURE IS A MESS", 1);
	game->text.col = mlx_load_png("./textures/collec.png");
	if (!game->text.col)
	...
	game->text.player = mlx_load_png("./textures/playerC.png");
	if (!game->text.player)

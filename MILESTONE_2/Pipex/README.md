...
FunciónUsofork()Crear procesos hijopipe()Crear canal de comunicacióndup2()Redirigir file descriptorsexecve()Ejecutar comandosaccess()Verificar existencia de archivosopen()Abrir archivosclose()Cerrar file descriptorswait()/waitpid()Esperar procesos hijoperror()Mostrar errores del sistema
